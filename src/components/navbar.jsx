                ...
                <div className="relative flex h-16 items-center justify-between">
                    <div className="inset-y-0 left-0 flex items-center md:hidden">
                        ...
                        >
                            ...
                            <svg className={hideMenu ? "block h-6 w-6" : 'hidden h-6 w-6'} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                            </svg>
                            {/* <!--Icon when menu is open--> */}
                            <svg className={hideMenu ? "hidden h-6 w-6" : 'block h-6 w-6'} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
