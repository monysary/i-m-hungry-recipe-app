                  ...
                  <Dialog.Panel className='relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-screen-md sm:p-6'>
                    <div>
                      <div className='px-4 sm:px-0'>
                        {editMode ? (
                          <>
                            {recipeModal?.createdAt !=
                              recipeModal?.updatedAt && (
                              <p className='italic text-sm text-gray-600 mb-2'>
                                last edited {getTimeAgo(recipeModal?.updatedAt)}
                              </p>
                            )}
                            <input
                          ...
                          <div className='flex flex-col gap-2 mb-2 md:mb-0'>
                            <p className='italic text-sm text-gray-600'>
                              {" "}
                              added {getTimeAgo(recipeModal?.createdAt)}
                            </p>
                            <div className='flex flex-col gap-4 md:gap-0 md:flex-row justify-between'>
                              ...
                              {!recipeModal?.postedToTimeline ? (
                                <button
                                  type='button'
                                  onClick={() =>
                                    handlePostToFeed(recipeModal?.id)
                                  }
                                  className='rounded-md sm:ml-0  text-gray-900 bg-white shadow-sm hover:bg-gray-50 transition ease-out ring-1 ring-inset ring-gray-300 font-semibold text-sm px-2.5 py-1.5'>
                                  Share to feed
                            ...
                            {shareSuccess &&
                              recipeModal.postedToTimeline === true && (
                                <div className=''>
                                  {" "}
                                  <SuccessNotification
                                    title='Successfully shared!'
                                    message='View your publicly shared post on the feed.'
                                    btnTitle='View post'
                                    href='/feed'
                                  />{" "}
                                </div>
                            ...
                            {shareSuccess &&
                              recipeModal.postedToTimeline === false && (
                                <div className=''>
                                  {" "}
                                  <SuccessNotification
                                    title='Removed post from feed!'
                                    message='The recipe is no longer publicly available'
                                  />{" "}
                                </div>
                              )}
                          </div>
