...
function Kitchen() {
    ...
    return (
        <>
            ...
            <div className="flex min-h-full flex-col justify-center md:px-[200px] px-6 py-12">
                ...
                <form>
                    ...
                    <div className="relative">
                        ...
                        <input type="search" id="default-search" className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-teal-500 focus:border-teal-500 " placeholder="Search Ingredients..." required />
