...
import PostContainer from "@/features/feed/OLD_postContainer"
  ...
  return (
    <div className='flex justify-center h-full min-h-[70vh] pb-24 bg-white md:mt-6 md:mx-4'>
      <div className='max-w-[1280px] w-full h-full px-2 md:px-0 py-6 '>
        <PageHeading />
        <PostContainer recipes={recipes} comments={comments} userId={userId} setFeedToggle={setFeedToggle} />
      </div>
    </div>
  )
}
